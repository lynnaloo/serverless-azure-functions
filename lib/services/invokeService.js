...
var InvokeService = /** @class */ (function (_super) {
    ...
    function InvokeService(serverless, options, local) {
        if (local === void 0) { local = false; }
        var _this = _super.call(this, serverless, options, !local) || this;
        _this.local = local;
        if (!local) {
    ...
    InvokeService.prototype.invoke = function (method, functionName, data) {
        return __awaiter(this, void 0, void 0, function () {
            var functionObject, eventType, url, queryString, options;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.local) {
                            return [2 /*return*/, this.getLocalHost() + "/api/" + this.getConfiguredFunctionRoute(functionName)];
                        }
    ...
    InvokeService.prototype.getLocalHost = function () {
        return "http://localhost:" + this.getOption("port", config_1.default.defaults.localPort);
    };
    InvokeService.prototype.getConfiguredFunctionRoute = function (functionName) {
        try {
            var route = this.config.functions[functionName].events[0]["x-azure-settings"].route;
    ...
    InvokeService.prototype.getQueryString = function (eventData) {
        ...
        return encodeURIComponent(Object.keys(eventData)
            .map(function (key) { return key + "=" + eventData[key]; })
            .join("&"));
    };
    /**
     * Get options object
    ...
    InvokeService.prototype.getRequestOptions = function (method, data) {
        return __awaiter(this, void 0, void 0, function () {
            var host, _a, options, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!(this.local)) return [3 /*break*/, 1];
                        _a = this.getLocalHost();
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.functionAppService.get()];
                    case 2:
                        _a = _e.sent();
                        _e.label = 3;
                    case 3:
                        ...
                        if (!!this.local) return [3 /*break*/, 5];
                        _b = options;
                        _c = {};
                        _d = "x-functions-key";
                        return [4 /*yield*/, this.functionAppService.getMasterKey()];
                    case 4:
                        _b.headers = (_c[_d] = _e.sent(),
                            _c);
                        _e.label = 5;
